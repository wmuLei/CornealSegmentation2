...
def EE-Net(shape, classes=1):
    ...
    conv6 = merge([conv6, edge1], mode='concat', concat_axis=3);  # 512/32
    #----------------------------------------------

    merg1 = UpSampling2D(size=(2, 2))(conv6);
    merg1 = merge([merg1, conv5], mode='concat', concat_axis=3) # 512/16
    ...
    merg1 = merge([merg1, conv4], mode='concat', concat_axis=3) # 512/8
    ...
    merg1 = merge([merg1, conv3], mode='concat', concat_axis=3) # 512/4
    ...
    merg1 = merge([merg1, conv2], mode='concat', concat_axis=3) # 512/4
    ...
    merg1 = merge([merg1, conv1], mode='concat', concat_axis=3) # 512/2
